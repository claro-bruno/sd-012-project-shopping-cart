...
const addProductCart = async (item) => {
  ...
  const productStorage = createCartItemElement({ sku, name, salePrice });
  add.appendChild(productStorage);
  localStorage.setItem(sku, productStorage.innerHTML);
...
// Requisit 03 -Adiciona o item ao carrinho
