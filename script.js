...
function getItemsPrice() {
  ...
  const itemsPrice = document.getElementsByClassName('total-price');
  
  price.forEach((element) => { totalPrice += Number(element.innerText); });
  itemsPrice[0].innerText = totalPrice;
}
